...
{   
    ...
    public function modulo(){
        ...
        $query = $this->db->get_where('sysm_menuusuario', array('cod_usuario' => $this->codUser,'cod_ruta' => $modu));
        $html = "";
        if($query->num_rows() > 0){
    ...
    public function menu(){
        ...
        if($this->codUser ==''){
            ...
            $asignados = $this->db->get_where('sysm_menuusuario', array('cod_usuario' => $this->codUser));
            $listMenu = [];
                ...
                foreach( $data as $row ) {
                    ...
                    switch ($x) {
                        ...
                        case 19:
                            for($j = 0; $j<count($json['menu']); $j++) {
                                for($k = 0; $k<count($json['menu'][$j]['sub']); $k++) {
                                    for($l = 0; $l<count(array($json['menu'][$j]['sub'][$k]['sub'])); $l++) {     
                                        if( isset($json['menu'][$j]['sub'][$k]['sub'][$l]['cod']) == substr($row['cod_menu'],0,14)) {
                        ...
                        case 24:
                            for($j = 0; $j<count($json['menu']); $j++) {
                                for($k = 0; $k<count($json['menu'][$j]['sub']); $k++) {
                                    for($l = 0; $l<count(array($json['menu'][$j]['sub'][$k]['sub'])); $l++) {    
                                        for($m = 0; $m<count(array(isset($json['menu'][$j]['sub'][$k]['sub'][$l]['sub']))); $m++) {
                                            if(isset($json['menu'][$j]['sub'][$k]['sub'][$l]['sub'][$m]['cod']) == substr($row['cod_menu'],0,19)) {
                        ...
                        case 29:
                            for($j = 0; $j<count($json['menu']); $j++) {
                                for($k = 0; $k<count($json['menu'][$j]['sub']); $k++) {
                                    for($l = 0; $l<count(array($json['menu'][$j]['sub'][$k]['sub'])); $l++) {    
                                        for($m = 0; $m<count(array(isset($json['menu'][$j]['sub'][$k]['sub'][$l]['sub']))); $m++) {
                                            for($n = 0; $n<count(array(isset($json['menu'][$j]['sub'][$k]['sub'][$l]['sub'][$m]['sub']))); $n++) {
                                                if(isset($json['menu'][$j]['sub'][$k]['sub'][$l]['sub'][$m]['sub'][$n]['cod']) == substr($row['cod_menu'],0,24)) {
